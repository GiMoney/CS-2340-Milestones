...
public class Universe extends Game {
    ...
    public Universe(String[] name) {
        ...
        LinkedList<String> preAgItems = new LinkedList<>(); // NEED to add quantity
        ...
        LinkedList<String> agItems = new LinkedList<>(); // NEED to add quantity
        ...
        LinkedList<String> medItems = new LinkedList<>(); // NEED to add quantity
        ...
        LinkedList<String> renItems = new LinkedList<>(); // NEED to add quantity
        ...
        LinkedList<String> indItems = new LinkedList<>(); // NEED to add quantity
        ...
        LinkedList<String> modItems = new LinkedList<>(); // NEED to add quantity
        ...
        LinkedList<String> futItems = new LinkedList<>(); // NEED to add quantity
        ...
        LinkedList<String> darkItems = new LinkedList<>(); // NEED to add quantity
        ...
        LinkedList<String> steamItems = new LinkedList<>(); // NEED to add quantity
        ...
        LinkedList<String> cybItems = new LinkedList<>(); // NEED to add quantity
